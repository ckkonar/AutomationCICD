...
public class SubmitOrderTest extends BaseTest {
	...
	public void OrderHistoryTest() {
		// "ZARA COAT 3";
		ProductCatalogue productCatalogue = landingPage.loginApplication("ckk@gmail.com", "Pass@2026");
	 ...
	 * HashMap<String, String>(); map.put("email", "ckk@gmail.com");
	 * map.put("password", "Pass@2026"); map.put("product", "ZARA COAT 3");
	 * 
	 * HashMap<String, String> map1 = new HashMap<String, String>();
	 * map1.put("email", "ckk1@gmail.com"); map1.put("password", "Pass@2026");
